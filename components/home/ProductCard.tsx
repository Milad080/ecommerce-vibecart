...
const Card = ({ product }: { product: Product }) => {
  return (
    <div className="w-[66vw] sm:w-full shrink-0 mb-2">
      <div className="relative">
        ...
        <div className="absolute top-2 left-2 flex gap-2">
          {product.isBestseller && (
            <span className="bg-[#E1BB7f] text-white text-xs font-semibold px-2 py-1 rounded">
              BEST SELLER
            </span>
          )}
          {product.isSale && (
            <span className="bg-[#7EBAFE] text-white text-xs font-semibold px-2 py-1 rounded">
              SALE
            </span>
          )}
        </div>
        {product.discount && (
          <span className="absolute bottom-2 left-2 bg-[#7EBAFE] text-xs text-white font-semibold px-2 py-1 rounded">
